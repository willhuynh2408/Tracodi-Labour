...
function translatedText(value, locale, fallback) {
  if (value && typeof value === "object" && !Array.isArray(value)) {
    return filledText(value[locale], filledText(value.vi, filledText(value.en, filledText(value.ja, fallback))));
  }
...
function normalizeSiteSettings(settings) {
  ...
  return {
    ...
    footerInfoItems: arrayWithFallback(source.footerInfoItems, fallback.footerInfoItems),
